...
public class MainPractice {
	public static void main(String[] args) {
		...
		//new ConditionControllerPractice().ifTest();
		//new ConditionControllerPractice().ifelseTest();
		//new ConditionControllerPractice().ifelseifTest();
		//new ConditionControllerPractice().doubleifTest();
		//new ConditionControllerPractice().switchTest();
